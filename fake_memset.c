...
gv__memset_func_t gvmemset;
/*
TODO Implement
	if (supports erms) gvmemset = version with stosb
	else if (supports simd) gvmemset = version with simd
	else  gvmemset = version with longs
 */
